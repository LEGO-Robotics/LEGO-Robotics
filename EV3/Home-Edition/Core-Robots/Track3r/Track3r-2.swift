...
left(nRotations: 1, power: 25, brake: true)
ev3.motorOn(forRotations: 3, on: .a, withPower: 100)
ev3.displayImage(named: .warning)
right(nRotations: 2, power: 25, brake: true)
ev3.motorOn(forRotations: 6, on: .a, withPower: 100)
